        ...
        <div className="inline-flex flex-col justify-start items-start gap-2.5">
          <div className="w-[442px] inline-flex justify-center items-center gap-[30px]">
            ...
            <div className="flex-1 inline-flex flex-col justify-start items-start gap-2.5">
              <div className="self-stretch text-start text-white text-[28px] font-normal font-['Inter']">{title}</div>
              <div className="self-stretch text-start text-[#c7c7c7] text-base font-normal font-['Istok_Web']">{content}</div>
            </div>
          </div>
        </div>
        {!archived && (
